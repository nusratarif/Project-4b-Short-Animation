...
var polyfillErr = "💡 use-web-animations: please enable polyfill to use this hook. See https://github.com/wellyshen/use-web-animations#disable-polyfill";
var eventErr = function eventErr(type) {
  return "\uD83D\uDCA1 use-web-animations: the browser doesn't support " + type + " event, please use onUpdate to monitor the animation's state instead. See https://github.com/wellyshen/use-web-animations#basic-usage";
};
...
var useWebAnimations = function useWebAnimations(_temp) {
  ...
  var animate = useCallback(function (args) {
    ...
    if (onFinishRef.current) {
      if (anim.finished) {
        anim.finished.then(function (animation) {
          // @ts-expect-error
          onFinishRef.current({
            playState: animation.playState,
            animate: animate,
  ...
  useEffect(function () {
    ...
    requestAnimationFrame(update); // eslint-disable-next-line react-hooks/exhaustive-deps
...
var transformOrigin$1 = "top center";
var swing = {
  keyframes: [{
...
var transformOrigin$2 = "center";
var frame = {
  transform: "translate3d(0, 0, 0)",
  transformOrigin: transformOrigin$2
};
var jello = {
  keyframes: [_extends({}, frame, {
    offset: 0
  }), _extends({}, frame, {
    offset: 0.111
  }), {
...
var transformOrigin$4 = "left bottom";
...
var transformOrigin$5 = "right bottom";
...
var transformOrigin$6 = "left bottom";
var rotateInUpLeft = {
  keyframes: [{
    transform: "rotate3d(0, 0, 1, 45deg)",
    opacity: 0,
...
var transformOrigin$7 = "right bottom";
var rotateInUpRight = {
  keyframes: [{
...
var transformOrigin$a = "right bottom";
...
var transformOrigin$b = "left bottom";
var rotateOutUpLeft = {
  keyframes: [{
    transform: "none",
    opacity: 1,
...
var transformOrigin$c = "right bottom";
...
var easing$5 = "ease-in-out";
var transformOrigin$d = "top left";
var frame1$6 = {
...
var transformOrigin$e = "center bottom";
var jackInTheBox = {
  keyframes: [{
...
var transformOrigin$f = "center bottom";
var zoomOutDown = {
  keyframes: [{
    transform: "none",
    opacity: 1,
...
var transformOrigin$g = "left center";
var zoomOutLeft = {
  keyframes: [{
    transform: "none",
    opacity: 1,
...
var transformOrigin$h = "right center";
var zoomOutRight = {
  keyframes: [{
    transform: "none",
    opacity: 1,
